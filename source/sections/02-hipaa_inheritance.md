...
## 2.1 HIPAA Inheritance for DaaS Customers

| **Administrative Controls** HIPAA Rule | NashBio Control | Inherited
--- | --- | ---
...
| **Physical Safeguards** HIPAA Rule | NashBio Control | Inherited
--- | --- | ---
...
| **Technical Safeguards** HIPAA Rule | NashBio Control | Inherited
--- | --- | ---
...
| **Organizational Requirements** HIPAA Rule | NashBio Control | Inherited
--- | --- | ---
...
| **Policies and Procedures and Documentation Requirements** HIPAA Rule | NashBio Control | Inherited
--- | --- | ---
...
| **HITECH Act - Security Provisions** HIPAA Rule | NashBio Control | Inherited
--- | --- | ---
