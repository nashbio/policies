...
7. Methods of Notification: Nashbio Customers will be notified via email and phone within the timeframe for reporting breaches, as outlined above.
   * Must find an effective alternative method of contacting individuals with their PHI breached if more than 10 cannot be reached for notification.
   * Must find an effective way to notify next of kin.
